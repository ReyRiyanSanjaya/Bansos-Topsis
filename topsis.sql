...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 27 Jan 2022 pada 18.20
...
(6, 'Harya Syafneldi', '0872163632', 'default.jpg', 0),
(7, 'reyna', '643436436', 'default.jpg', 0);
...
(12, '12', '12', 'Harya Syafneldi', 'jL. Pancing', 'default.jpg', 2);
...
--
ALTER TABLE `petugas`
  MODIFY `id_petugas` int(32) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
