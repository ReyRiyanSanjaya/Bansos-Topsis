                            ...
                            <div class="table-responsive">
                                <table id="datatable" class="display" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        $sql=mysqli_query($koneksi,"SELECT * FROM kriteria,pemilik,analisa WHERE kriteria.id_kriteria = analisa.id_kriteria AND pemilik.id_pemilik = analisa.id_pemilik
