...
<div class="container">
      <div class="row">
        <div class="col-lg-12">
                                        ...
                                        <h1 class="mt-5">CALON PENERIMA BANTUAN TERBAIK</h1>
                                    ...
                                    // ======================================================================== //
                                    echo "<b>Hasil Akhir Analisa Metode Topsis Dengan Nilai bobot preferensi sebagai :  h = (5,4,3,3,2,2)</b></br>";
                                    echo "Jadi dapat disimpulkan bahwa Alternatif terbaik menggunakan metode topsis adalah <b class='badge bg-primary'>".ucwords(($hsl[0][0]))."</b> dengan nilai Metode Topsis <b>".$hsl[0][1]."</b>.<br><br>";
