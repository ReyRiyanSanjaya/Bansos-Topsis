											...
											<div class="table-responsive">
												...
												<div class="tab-content">
													...
													<div class="tab-pane container fade" id="menu3">
														...
														echo "Berikut ini hasil analisa diurutkan berdasarkan ha    sil nilai tertinggi. </br>Jadi dapat disimpulkan bahwa Alternatif terbaik adalah <b>" . ucwords(($hsl[0][0])) . "</b> dengan nilai <b>" . $hsl[0][1] . "</b>.";
														echo "<table class='table table-striped table-bordered table-hover'>";
